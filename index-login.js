...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: '307d5f41-97e8-4a64-a165-7bfbf0e4b9cf', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://nisacheng-snake-squad.glitch.me/', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
